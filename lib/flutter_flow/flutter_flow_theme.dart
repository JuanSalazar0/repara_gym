...
abstract class FlutterFlowTheme {
  ...
  late Color ferbelBlack;
  late Color ferbelRed;
  late Color ferbelGrey;
  late Color ferbelWhite;
  late Color carbonNeutral300;
  late Color carbonDarkest;
  late Color systemOrangeLight;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color customColor1 = const Color(0xFFE6E6E6);
  late Color customColor2 = const Color(0xFF000000);
  late Color customColor3 = const Color(0xFFF5F5F5);
  late Color ferbelBlack = const Color(0xFF131515);
  late Color ferbelRed = const Color(0xFFFB373A);
  late Color ferbelGrey = const Color(0xFFBFC3C6);
  late Color ferbelWhite = const Color(0xFFFFFFFF);
  late Color carbonNeutral300 = const Color(0xFFD6D9DD);
  late Color carbonDarkest = const Color(0xFF24262B);
  late Color systemOrangeLight = const Color(0xFFFF9500);
}
